...
export class Spinner {
    ...
    public static setStyle(elmId: string, color: string, width: number, height: number, property: string = "px") {
        try {
            ...
            if (!elm) {
                ...
                elm.style.width = width + property;
                elm.style.height = height + property;
            }
        } catch (error) {
            console.log(error)
        }
